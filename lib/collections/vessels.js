...
VesselsDeatils = new Mongo.Collection('vesselsdetails');

vesselTypesAF = [
  {label: 'Multipurpose vessel', value: 'mpp'},
  {label: 'Tanker', value: 'tanker'},
  {label: 'Bulker', value: 'bulker'},
  {label: 'RO-RO type vessel', value: 'ro-ro'}
];

vesselTypesWBX = ['bulker', 'tanker', 'mpp', 'ro-ro'];
